...
public static class FriendshipErrors
{
    ...
    public static readonly Error CannotAddSelf = Error.Conflict("Friendships.CannotAddSelf", "You cannot send a friend request to yourself");
    ...
    public static readonly Error Unauthorized = Error.Conflict("Friendships.Unauthorized", "You are not authorized to perform this action");
