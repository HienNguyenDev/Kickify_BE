...
namespace Kickify.Application.Features.Auth.Commands.RegisterVenueOwner
{
    public class RegisterVenueOwnerCommandHandler : ICommandHandler<RegisterVenueOwnerCommand, RegisterVenueOwnerCommandResponse>
    {
        ...
        public RegisterVenueOwnerCommandHandler(IUserRepository userRepository, IAuthenticationServices authenticationServices, IPasswordHasher passwordHasher, IOtpGenerator otpGenerator, IRedisOtpStore otpStore, IUnitOfWork unitOfWork)
        {
