...
namespace Kickify.Application.Abstractions.Repositories
{
    public interface IRoomParticipantRepository : IGenericRepository<RoomParticipant>
    {
        ...
        /// <summary>
        /// Get the count of checked-in participants in a room
        /// </summary>
        Task<int> GetCheckedInCountAsync(Guid roomId, CancellationToken cancellationToken = default);
        
        /// <summary>
        /// Get all participants in a room
        /// </summary>
        Task<List<RoomParticipant>> GetParticipantsByRoomAsync(Guid roomId, CancellationToken cancellationToken = default);
    }
}
