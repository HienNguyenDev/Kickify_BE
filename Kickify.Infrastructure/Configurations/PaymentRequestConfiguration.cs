...
public class PaymentRequestConfiguration : IEntityTypeConfiguration<PaymentRequest>
{
    public void Configure(EntityTypeBuilder<PaymentRequest> builder)
    {
        ...
        // Relationships - User is optional to avoid query filter warning
        // User has soft delete global filter, so we configure navigation as optional
